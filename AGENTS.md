...
1. **Frontend Development (`apps/frontend`)**:
   👉 Read [apps/frontend/AGENTS.md](file:///home/husni-kusuma/Project-envoyou/EAI/apps/frontend/AGENTS.md)
...
2. **Backend Development (`apps/backend`)**:
   👉 Read [apps/backend/AGENTS.md](file:///home/husni-kusuma/Project-envoyou/EAI/apps/backend/AGENTS.md)
...
* 📄 [Architecture Notes](file:///home/husni-kusuma/Project-envoyou/EAI/docs/architecture-notes.md) — Detailed design of the intelligent content analysis and AI editor system.
* 📄 [Future Roadmap](file:///home/husni-kusuma/Project-envoyou/EAI/docs/future-roadmap.md) — Multi-phase plans for workspace upgrades and CMS integrations.
* 📄 [Prompt Evolution](file:///home/husni-kusuma/Project-envoyou/EAI/docs/prompt-evolution.md) — Documentation of prompt engineering history and prompt designs.

### Database & Infrastructure
* 📄 [Railway Deployment & Migration Guide](file:///home/husni-kusuma/Project-envoyou/EAI/docs/RAILWAY-MIGRATION.md) — Operational instructions for active Express backend servers on Railway.
* 📄 [Prisma Production Database Migrations](file:///home/husni-kusuma/Project-envoyou/EAI/docs/PRODUCTION_DATABASE_MIGRATIONS.md) — Database change workflows on Neon Serverless.
* 📄 [Legacy VPS Guide](file:///home/husni-kusuma/Project-envoyou/EAI/docs/PRODUCTION-VPS.md) — Archived guide for the historical VPS setup.

### Frontend & Third-Party Integrations
* 📄 [Midtrans Production Checklist](file:///home/husni-kusuma/Project-envoyou/EAI/docs/frontend/MIDTRANS_PRODUCTION.md) — Production setup for the Midtrans payment gateway.
* 📄 [Zoho Desk Integration](file:///home/husni-kusuma/Project-envoyou/EAI/docs/frontend/ZOHO_DESK.md) — Operational configuration for support forms.
* 📄 [Editorial Philosophy](file:///home/husni-kusuma/Project-envoyou/EAI/docs/frontend/editorial-philosophy.md) — Core concepts driving the Envoyou smart editorial workspace.
* 📄 [Evaluation Benchmark](file:///home/husni-kusuma/Project-envoyou/EAI/docs/frontend/evaluation-benchmark.md) — Content quality benchmark and evaluation strategies for the AI system.

### Regulatory & Legal Compliance
* 📁 [Regulatory Documents Folder](file:///home/husni-kusuma/Project-envoyou/EAI/docs/complience/) — Official company documents including:
  * [NIB EAI (PDF)](file:///home/husni-kusuma/Project-envoyou/EAI/docs/complience/NIB_EAI.pdf) — Business Identification Number.
  * [NPWP Perorangan (PDF)](file:///home/husni-kusuma/Project-envoyou/EAI/docs/complience/NPWP_PERORANGAN.pdf) — Personal Tax Identification Number.
  * [Pendaftaran PSE EAI (PDF)](file:///home/husni-kusuma/Project-envoyou/EAI/docs/complience/PSE_EAI.pdf) — PSE Registration Certificate.
  * [Executive Brief Co-Founder (PDF)](file:///home/husni-kusuma/Project-envoyou/EAI/docs/complience/EAI_Executive_Brief_CoFounder.pdf) — Executive brief for the Co-Founder.
...
If you make structural updates to the monorepo, global scripts, or package configurations, you must update this root [AGENTS.md](file:///home/husni-kusuma/Project-envoyou/EAI/AGENTS.md) file. For specific frontend UI components or backend API routing questions, update the corresponding `AGENTS.md` in [apps/frontend/AGENTS.md](file:///home/husni-kusuma/Project-envoyou/EAI/apps/frontend/AGENTS.md) or [apps/backend/AGENTS.md](file:///home/husni-kusuma/Project-envoyou/EAI/apps/backend/AGENTS.md) instead.
